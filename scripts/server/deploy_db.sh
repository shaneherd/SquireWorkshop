...
for FILE in /home/$username/squire/database/scripts/new/*;
do
  echo $FILE;
  mysql -u root -p 'squire' < $FILE;
  echo "$FILE complete";
done
mv /home/$username/squire/database/scripts/new/* /home/$username/squire/database/scripts/deployed
