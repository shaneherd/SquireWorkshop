DROP PROCEDURE IF EXISTS Items_GetList_Ammos;

DELIMITER ;;
CREATE PROCEDURE Items_GetList_Ammos(
...
BEGIN
    ...
    FROM temp_list ui
        ...
        JOIN ammos a ON a.item_id = i.id
...
# CALL Items_GetList_Ammos(1, null, 0, 1000, 1);