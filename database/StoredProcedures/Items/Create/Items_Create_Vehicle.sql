DROP PROCEDURE IF EXISTS Items_Create_Vehicle;

DELIMITER ;;
CREATE PROCEDURE Items_Create_Vehicle(
...
BEGIN
    ...
    VALUES (itemName, 10, itemDescription, 0, 0, null, 1, 0, costValue, costUnit, weightValue, userId);

    SET itemId = (SELECT LAST_INSERT_ID());

    INSERT INTO vehicles (item_id)
    VALUES (itemId);
...
# CALL Items_Create_Vehicle('test', 'test_description', 1, 'tst', 1);
