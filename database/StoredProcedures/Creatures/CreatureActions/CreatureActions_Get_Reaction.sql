DROP PROCEDURE IF EXISTS CreatureActions_Get_Reaction;

DELIMITER ;;
CREATE PROCEDURE CreatureActions_Get_Reaction(
...
CALL CreatureActions_Get_Reaction(1);
