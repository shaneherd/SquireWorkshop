DROP PROCEDURE IF EXISTS Attributes_GetList_Abilities;

DELIMITER ;;
CREATE PROCEDURE Attributes_GetList_Abilities(
...
# CALL Attributes_GetList_Abilities(1, null, 0, 1000, 1);
