DROP PROCEDURE IF EXISTS Attributes_Create_SpellSchool;

DELIMITER ;;
CREATE PROCEDURE Attributes_Create_SpellSchool(
...
BEGIN
    ...
    VALUES (attributeName, attributeDescription, 13, userId);

    SET attributeId = (SELECT LAST_INSERT_ID());

    INSERT INTO spell_schools (attribute_id)
    VALUES (attributeId);
...
# CALL Attributes_Create_SpellSchool('test', 'test_description', 1, 'tst', 1);
