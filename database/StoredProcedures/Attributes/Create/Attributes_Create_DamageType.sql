DROP PROCEDURE IF EXISTS Attributes_Create_DamageType;

DELIMITER ;;
CREATE PROCEDURE Attributes_Create_DamageType(
...
BEGIN
    ...
    VALUES (attributeName, attributeDescription, 5, userId);

    SET attributeId = (SELECT LAST_INSERT_ID());

    INSERT INTO damage_types (attribute_id)
    VALUES (attributeId);
...
# CALL Attributes_Create_DamageType('test', 'test_description', 1, 'tst', 1);
