...
('+1 Armor', @magicalItemId, 'You have a bonus to AC while wearing this armor. The bonus is determined by its rarity.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 3),
('+2 Armor', @magicalItemId, 'You have a bonus to AC while wearing this armor. The bonus is determined by its rarity.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 4),
('+3 Armor', @magicalItemId, 'You have a bonus to AC while wearing this armor. The bonus is determined by its rarity.', 0, 1, @bodySlotId, 0, 0, 50001, @gpId, 0.0, userId, 5),
...
('Armor of Resistance - Acid', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 7),
('Armor of Resistance - Cold', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 8),
('Armor of Resistance - Fire', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 9),
('Armor of Resistance - Force', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 10),
('Armor of Resistance - Lightning', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 11),
('Armor of Resistance - Necrotic', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 12),
('Armor of Resistance - Poison', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 13),
('Armor of Resistance - Psychic', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 14),
('Armor of Resistance - Radiant', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 15),
('Armor of Resistance - Thunder', @magicalItemId, 'You have resistance to one type of damage while you wear this armor.', 0, 1, @bodySlotId, 0, 0, 501, @gpId, 0.0, userId, 16),
...
('Dragon Scale Mail - Black (Acid)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 20),
('Dragon Scale Mail - Blue (Lightning)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 21),
('Dragon Scale Mail - Brass (Fire)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 22),
('Dragon Scale Mail - Bronze (Lightning)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 23),
('Dragon Scale Mail - Copper (Acid)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 24),
('Dragon Scale Mail - Gold (Fire)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 25),
('Dragon Scale Mail - Green (Poison)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 26),
('Dragon Scale Mail - Red (Fire)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 27),
('Dragon Scale Mail - Silver (Cold)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 28),
('Dragon Scale Mail - White (Cold)', @magicalItemId, 'Dragon scale mail is made of the scales of one kind of dragon. Sometimes dragons collect their cast-off scales and gift them to humanoids. Other times, hunters carefully skin and preserve the hide of a dead dragon. In either case, dragon scale mail is highly valued.\n\nWhile wearing this armor, you gain a +1 bonus to AC, you have advantage on saving throws against the Frightful Presence and breath weapons of dragons, and you have resistance to one damage type that is determined by the kind of dragon that provided the scales.\n\nAdditionally, you can focus your senses as an action to magically discern the distance and direction to the closest dragon within 30 miles of you that is of the same type as the armor. This special action can’t be used again until the next dawn.', 0, 1, @bodySlotId, 0, 0, 5001, @gpId, 0.0, userId, 29),
...
('Potion of Giant Strength - Hill Giant', @magicalItemId, 'When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Strength is equal to or greater than that score.\n\nThis potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. The potion of frost giant strength and the potion of stone giant strength have the same effect.\n\nStrength: 21', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 50),
('Potion of Giant Strength - Frost/Stone Giant', @magicalItemId, 'When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Strength is equal to or greater than that score.\n\nThis potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. The potion of frost giant strength and the potion of stone giant strength have the same effect.\n\nStrength: 23', 1, 0, NULL, 0, 0, 250, @gpId, 0.0, userId, 51),
('Potion of Giant Strength - Fire Giant', @magicalItemId, 'When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Strength is equal to or greater than that score.\n\nThis potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. The potion of frost giant strength and the potion of stone giant strength have the same effect.\n\nStrength: 25', 1, 0, NULL, 0, 0, 250, @gpId, 0.0, userId, 52),
('Potion of Giant Strength - Cloud Giant', @magicalItemId, 'When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Strength is equal to or greater than that score.\n\nThis potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. The potion of frost giant strength and the potion of stone giant strength have the same effect.\n\nStrength: 27', 1, 0, NULL, 0, 0, 2500, @gpId, 0.0, userId, 53),
('Potion of Giant Strength - Storm Giant', @magicalItemId, 'When you drink this potion, your Strength score changes for 1 hour. The type of giant determines the score (see the table below). The potion has no effect on you if your Strength is equal to or greater than that score.\n\nThis potion’s transparent liquid has floating in it a sliver of fingernail from a giant of the appropriate type. The potion of frost giant strength and the potion of stone giant strength have the same effect.\n\nStrength: 29', 1, 0, NULL, 0, 0, 25000, @gpId, 0.0, userId, 54),
...
('Potion of Resistance - Acid', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 64),
('Potion of Resistance - Cold', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 65),
('Potion of Resistance - Fire', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 66),
('Potion of Resistance - Force', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 67),
('Potion of Resistance - Lightning', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 68),
('Potion of Resistance - Necrotic', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 69),
('Potion of Resistance - Poison', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 70),
('Potion of Resistance - Psychic', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 71),
('Potion of Resistance - Radiant', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 72),
('Potion of Resistance - Thunder', @magicalItemId, 'When you drink this potion, you gain resistance to one type of damage for 1 hour.', 1, 0, NULL, 0, 0, 50, @gpId, 0.0, userId, 73),
...
('Ring of Resistance - Acid (Pearl)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 90),
('Ring of Resistance - Cold (Tourmaline)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 91),
('Ring of Resistance - Fire (Garnet)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 92),
('Ring of Resistance - Force (Sapphire)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 93),
('Ring of Resistance - Lightning (Citrine)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 94),
('Ring of Resistance - Necrotic (Jet)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 95),
('Ring of Resistance - Poison (Amethyst)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 96),
('Ring of Resistance - Psychic (Jade)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 97),
('Ring of Resistance - Radiant (Topaz)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 98),
('Ring of Resistance - Thunder (Spinel)', @magicalItemId, 'You have resistance to one damage type while wearing this ring. The gem in the ring indicates the type.', 0, 1, @fingerSlotId, 0, 0, 501, @gpId, 0.0, userId, 99),
...
('+1 Wand of the War Mage', @magicalItemId, 'While holding this wand, you gain a bonus to spell attack rolls determined by the wand''s rarity. In addition, you ignore half cover when making a spell attack.\n\n(Requires Spellcaster)', 0, 1, @handSlotId, 0, 0, 101, @gpId, 0.0, userId, 139),
('+2 Wand of the War Mage', @magicalItemId, 'While holding this wand, you gain a bonus to spell attack rolls determined by the wand''s rarity. In addition, you ignore half cover when making a spell attack.\n\n(Requires Spellcaster)', 0, 1, @handSlotId, 0, 0, 501, @gpId, 0.0, userId, 140),
('+3 Wand of the War Mage', @magicalItemId, 'While holding this wand, you gain a bonus to spell attack rolls determined by the wand''s rarity. In addition, you ignore half cover when making a spell attack.\n\n(Requires Spellcaster)', 0, 1, @handSlotId, 0, 0, 5001, @gpId, 0.0, userId, 141),
('Wand of Web', @magicalItemId, 'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the web spell (save DC 15) from it.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand’s last charge, roll a d20. On a 1, the wand crumbles into ashes and is destroyed.\n\n(Requires Spellcaster)', 0, 1, @handSlotId, 0, 0, 101, @gpId, 0.0, userId, 142),
('Wand of Wonder', @magicalItemId, 'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges and choose a target within 120 feet of you. The target can be a creature, an object, or a point in space. Roll d100 and consult the following table to discover what happens.\n\nIf the effect causes you to cast a spell from the wand, the spell’s save DC is 15. If the spell normally has a range expressed in feet, its range becomes 120 feet if it isn’t already.\n\nIf an effect covers an area, you must center the spell on and include the target. If an effect has multiple possible subjects, the GM randomly determines which ones are affected.\n\nThe wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand’s last charge, roll a d20. On a 1, the wand crumbles into dust and is destroyed.\n\n(Requires Spellcaster)', 0, 1, @handSlotId, 0, 0, 501, @gpId, 0.0, userId, 143),
('+1 Ammunition', @magicalItemId, 'You have a bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0, 1, @handSlotId, 0, 0, 101, @gpId, 0.0, userId, 144),
('+2 Ammunition', @magicalItemId, 'You have a bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0, 1, @handSlotId, 0, 0, 101, @gpId, 0.0, userId, 145),
('+3 Ammunition', @magicalItemId, 'You have a bonus to attack and damage rolls made with this piece of magic ammunition. Once it hits a target, the ammunition is no longer magical.', 0, 1, @handSlotId, 0, 0, 101, @gpId, 0.0, userId, 146),
('Arrow of Slaying', @magicalItemId, 'An arrow of slaying is a magic weapon meant to slay a particular kind of creature. Some are more focused than others; for example, there are both arrows of dragon slaying and arrows of blue dragon slaying. If a creature belonging to the type, race, or group associated with an arrow of slaying takes damage from the arrow, the creature must make a DC 17 Constitution saving throw, taking an extra 6d10 piercing damage on a failed save, or half as much extra damage on a successful one.\n\nOnce an arrow of slaying deals its extra damage to a creature, it becomes a non-magical arrow.\n\nOther types of magic ammunition of this kind exist, such as bolts of slaying meant for a crossbow, though arrows are most common.', 0, 1, @handSlotId, 0, 0, 5001, @gpId, 0.0, userId, 147),
...
('+1 Weapon', @magicalItemId, 'You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon''s rarity.', 0, 1, @handSlotId, 0, 0, 101, @gpId, 0.0, userId, 173),
('+2 Weapon', @magicalItemId, 'You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon''s rarity.', 0, 1, @handSlotId, 0, 0, 501, @gpId, 0.0, userId, 174),
('+3 Weapon', @magicalItemId, 'You have a bonus to attack and damage rolls made with this magic weapon. The bonus is determined by the weapon''s rarity.', 0, 1, @handSlotId, 0, 0, 5001, @gpId, 0.0, userId, 175),
...
('Amulet of the Planes', @magicalItemId, 'While wearing this amulet, you can use an action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence check. On a successful check, you cast the plane shift spell. On a failure, you and each creature and object within 15 feet of you travel to a random destination. Roll a d100. On a 1–60, you travel to a random location on the plane you named. On a 61–100, you travel to a randomly determined plane of existence.', 0, 1, @neckSlotId, 0, 0, 501, @gpId, 0.0, userId, 179),
...
('Belt of Giant Strength - Hill Giant', @magicalItemId, 'While wearing this belt, your Strength score changes to a score granted by the belt. If your Strength is already equal to or greater than the belt’s score, the item has no effect on you.\n\nSix varieties of this belt exist, corresponding with and having rarity according to the six kinds of true giants. The belt of stone giant strength and the belt of frost giant strength look different, but they have the same effect.\n\nStrength 21', 0, 1, @waistSlotId, 0, 0, 501, @gpId, 0.0, userId, 189),
('Belt of Giant Strength - Stone/Frost Giant', @magicalItemId, 'While wearing this belt, your Strength score changes to a score granted by the belt. If your Strength is already equal to or greater than the belt’s score, the item has no effect on you.\n\nSix varieties of this belt exist, corresponding with and having rarity according to the six kinds of true giants. The belt of stone giant strength and the belt of frost giant strength look different, but they have the same effect.\n\nStrength 23', 0, 1, @waistSlotId, 0, 0, 5001, @gpId, 0.0, userId, 190),
('Belt of Giant Strength - Fire Giant', @magicalItemId, 'While wearing this belt, your Strength score changes to a score granted by the belt. If your Strength is already equal to or greater than the belt’s score, the item has no effect on you.\n\nSix varieties of this belt exist, corresponding with and having rarity according to the six kinds of true giants. The belt of stone giant strength and the belt of frost giant strength look different, but they have the same effect.\n\nStrength 25', 0, 1, @waistSlotId, 0, 0, 5001, @gpId, 0.0, userId, 191),
('Belt of Giant Strength- Cloud Giant', @magicalItemId, 'While wearing this belt, your Strength score changes to a score granted by the belt. If your Strength is already equal to or greater than the belt’s score, the item has no effect on you.\n\nSix varieties of this belt exist, corresponding with and having rarity according to the six kinds of true giants. The belt of stone giant strength and the belt of frost giant strength look different, but they have the same effect.\n\nStrength 27', 0, 1, @waistSlotId, 0, 0, 50001, @gpId, 0.0, userId, 192),
('Belt of Giant Strength - Storm Giant', @magicalItemId, 'While wearing this belt, your Strength score changes to a score granted by the belt. If your Strength is already equal to or greater than the belt’s score, the item has no effect on you.\n\nSix varieties of this belt exist, corresponding with and having rarity according to the six kinds of true giants. The belt of stone giant strength and the belt of frost giant strength look different, but they have the same effect.\n\nStrength 29', 0, 1, @waistSlotId, 0, 0, 50001, @gpId, 0.0, userId, 193),
...
('Bracers of Defense', @magicalItemId, 'While wearing these bracers, you gain a +2 bonus to AC if you are wearing no armor and using no shield.', 0, 1, @glovesSlotId, 0, 0, 501, @gpId, 3.0, userId, 201),
...
('Necklace of Fireballs', @magicalItemId, 'This necklace has 1d6 + 3 beads hanging from it. You can use an action to detach a bead and throw it up to 60 feet away. When it reaches the end of its trajectory, the bead detonates as a 3-rd level fireball spell (save DC 15).\n\nYou can hurl multiple beads, or even the whole necklace, as one action. When you do so, increase the level of the fireball by 1 for each bead beyond the first.', 0, 1, @neckSlotId, 0, 0, 501, @gpId, 0.0, userId, 306),
('Necklace of Prayer Beads', @magicalItemId, 'This necklace has 1d4 + 2 magic beads made from aquamarine, black pearl, or topaz. It also has many non-magical beads made from stones such as amber, bloodstone, citrine, coral, jade, pearl, or quartz. If a magic bead is removed from the necklace, that bead loses its magic.\n\nSix types of magic beads exist. The GM decides the type of each bead on the necklace or determines it randomly. A necklace can have more than one bead of the same type. To use one, you must be wearing the necklace. Each bead contains a spell that you can cast from it as a bonus action (using your spell save DC if a save is necessary). Once a magic bead’s spell is cast, that bead can’t be used again until the next dawn.\n\n(Requires Cleric, Druid, or Paladin)', 0, 1, @neckSlotId, 0, 0, 501, @gpId, 0.0, userId, 307),
('Pearl of Power', @magicalItemId, 'While this pearl is on your person, you can use an action to speak its command word and regain one expended spell slot. If the expended slot was of 4th level or higher, the new slot is 3rd level. Once you use the pearl, it can?t be used again until the next dawn.\n\n(Requires Spellcaster)', 0, 0, NULL, 0, 0, 101, @gpId, 0.0, userId, 308),
...
SET @PotionOfGiantStrengthFrostStoneGiantId = (SELECT id FROM items WHERE name = 'Potion of Giant Strength - Frost/Stone Giant' AND user_id = userId AND item_type_id = @magicalItemId);
...
SET @BeltOfGiantStrengthStoneFrostGiantId = (SELECT id FROM items WHERE name = 'Belt of Giant Strength - Stone/Frost Giant' AND user_id = userId AND item_type_id = @magicalItemId);
...
(@ArmorOfInvulnerabilityId, @magicalArmorTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@DragonScaleMailBlackAcidId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailBlueLightningId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailBrassFireId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailBronzeLightningId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailCopperAcidId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailGoldFireId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailGreenPoisonId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailRedFireId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailSilverColdId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@DragonScaleMailWhiteColdId, @magicalArmorTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 1, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PlateArmorOfEtherealnessId, @magicalArmorTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PotionOfAnimalFriendshipId, @magicalPotionTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PotionOfGiantStrengthFrostStoneGiantId, @magicalPotionTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PotionOfHealingId, @magicalPotionTypeId, @commonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PotionOfGreaterHealingId, @magicalPotionTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PotionOfSuperiorHealingId, @magicalPotionTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PotionOfSupremeHealingId, @magicalPotionTypeId, @veryRareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PotionOfHeroismId, @magicalPotionTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PotionOfMindReadingId, @magicalPotionTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PotionOfPoisonId, @magicalPotionTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@RingOfAnimalInfluenceId, @magicalRingTypeId, @rareRarityId, 0, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@RingOfAirElementalCommandId, @magicalRingTypeId, @legendaryRarityId, 1, '', 5, 1, 1, @d4Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RingOfEarthElementalCommandId, @magicalRingTypeId, @legendaryRarityId, 1, '', 5, 1, 1, @d4Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RingOfFireElementalCommandId, @magicalRingTypeId, @legendaryRarityId, 1, '', 5, 1, 1, @d4Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RingOfWaterElementalCommandId, @magicalRingTypeId, @legendaryRarityId, 1, '', 5, 1, 1, @d4Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RingOfEvasionId, @magicalRingTypeId, @rareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@RingOfRegenerationId, @magicalRingTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@RingOfShootingStarsId, @magicalRingTypeId, @veryRareRarityId, 1, '', 6, 1, 1, @d6Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RingOfSpellStoringId, @magicalRingTypeId, @rareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 1, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@RingOfTheRamId, @magicalRingTypeId, @rareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@RodOfAlertnessId, @magicalRodTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RodOfLordlyMightId, @magicalRodTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RodOfRulershipId, @magicalRodTypeId, @rareRarityId, 1, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RodOfSecurityId, @magicalRodTypeId, @veryRareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@SpellScrollId, @magicalScrollTypeId, @commonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 1, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfCharmingId, @magicalStaffTypeId, @rareRarityId, 1, '', 10, 1, 1, @d8Id, 2, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfFireId, @magicalStaffTypeId, @veryRareRarityId, 1, '', 10, 1, 1, @d6Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfFrostId, @magicalStaffTypeId, @veryRareRarityId, 1, '', 10, 1, 1, @d6Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfHealingId, @magicalStaffTypeId, @rareRarityId, 1, '', 10, 1, 1, @d6Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfPowerId, @magicalStaffTypeId, @veryRareRarityId, 1, '', 20, 1, 2, @d8Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfStrikingId, @magicalStaffTypeId, @veryRareRarityId, 1, '', 10, 1, 1, @d6Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfSwarmingInsectsId, @magicalStaffTypeId, @rareRarityId, 1, '', 10, 1, 1, @d6Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfTheMagiId, @magicalStaffTypeId, @legendaryRarityId, 1, '', 50, 1, 4, @d6Id, 2, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfThePythonId, @magicalStaffTypeId, @uncommonRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@StaffOfTheWoodlandsId, @magicalStaffTypeId, @rareRarityId, 1, '', 10, 1, 1, @d6Id, 4, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@StaffOfWitheringId, @magicalStaffTypeId, @rareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfBindingId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfEnemyDetectionId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfFearId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfFireballsId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfLightningBoltsId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfMagicDetectionId, @magicalWandTypeId, @uncommonRarityId, 0, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfMagicMissilesId, @magicalWandTypeId, @uncommonRarityId, 0, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfParalysisId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfPolymorphId, @magicalWandTypeId, @veryRareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfSecretsId, @magicalWandTypeId, @uncommonRarityId, 0, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@Plus1WandOfTheWarMageId, @magicalWandTypeId, @uncommonRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@Plus2WandOfTheWarMageId, @magicalWandTypeId, @rareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@Plus3WandOfTheWarMageId, @magicalWandTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfWebId, @magicalWandTypeId, @uncommonRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@WandOfWonderId, @magicalWandTypeId, @rareRarityId, 1, '', 7, 1, 1, @d6Id, 1, 1, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@Plus1AmmunitionId, @magicalWeaponTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 1, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@Plus2AmmunitionId, @magicalWeaponTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 2, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@Plus3AmmunitionId, @magicalWeaponTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 3, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@ArrowOfSlayingId, @magicalWeaponTypeId, @veryRareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@DaggerOfVenomId, @magicalWeaponTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 1, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@DwarvenThrowerId, @magicalWeaponTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 3, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@HammerOfThunderboltsId, @magicalWeaponTypeId, @legendaryRarityId, 1, '', 5, 1, 1, @d4Id, 1, 0, 0, 1, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@HolyAvengerId, @magicalWeaponTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 3, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@JavelinOfLightningId, @magicalWeaponTypeId, @uncommonRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@MaceOfTerrorId, @magicalWeaponTypeId, @rareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@TridentOfFishCommandId, @magicalWeaponTypeId, @uncommonRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 1, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@AmuletOfThePlanesId, @magicalWondrousTypeId, @rareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@BagOfTricksGrayId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@BagOfTricksRustId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@BagOfTricksTanId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@BeadOfForceId, @magicalWondrousTypeId, @rareRarityId, 0, '', 8, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@BeltOfGiantStrengthStoneFrostGiantId, @magicalWondrousTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@BowlOfCommandWaterElementalsId, @magicalWondrousTypeId, @rareRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@BrazierOfCommandingFireElementalsId, @magicalWondrousTypeId, @rareRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@CapeOfTheMountebankId, @magicalWondrousTypeId, @rareRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@CenserOfControllingAirElementalsId, @magicalWondrousTypeId, @rareRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@ChimeOfOpeningId, @magicalWondrousTypeId, @rareRarityId, 0, '', 10, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CircletOfBlastingId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CloakOfArachnidaId, @magicalWondrousTypeId, @veryRareRarityId, 1, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@CloakOfTheBatId, @magicalWondrousTypeId, @rareRarityId, 1, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@CrystalBallId, @magicalWondrousTypeId, @veryRareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CrystalBallOfMindReadingId, @magicalWondrousTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CrystalBallOfTelepathyId, @magicalWondrousTypeId, @legendaryRarityId, 1, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CrystalBallOfTrueSeeingId, @magicalWondrousTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CubeOfForceId, @magicalWondrousTypeId, @rareRarityId, 1, '', 36, 1, 1, @d20Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@CubicGateId, @magicalWondrousTypeId, @legendaryRarityId, 0, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@EfreetiBottleId, @magicalWondrousTypeId, @veryRareRarityId, 0, '', 3, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@EyesOfCharmingId, @magicalWondrousTypeId, @uncommonRarityId, 1, '', 3, 1, 0, @d1Id, 3, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@GemOfSeeingId, @magicalWondrousTypeId, @rareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@HelmOfTelepathyId, @magicalWondrousTypeId, @uncommonRarityId, 1, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@HelmOfTeleportationId, @magicalWondrousTypeId, @rareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@HornOfBlastingId, @magicalWondrousTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@IronBandsOfBindingId, @magicalWondrousTypeId, @rareRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@MedallionOfThoughtsId, @magicalWondrousTypeId, @uncommonRarityId, 1, '', 3, 1, 1, @d1Id, 3, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@NecklaceOfFireballsId, @magicalWondrousTypeId, @rareRarityId, 0, '', 9, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@NecklaceOfPrayerBeadsId, @magicalWondrousTypeId, @rareRarityId, 1, '', 6, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PearlOfPowerId, @magicalWondrousTypeId, @uncommonRarityId, 1, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PipesOfHauntingId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PipesOfTheSewersId, @magicalWondrousTypeId, @uncommonRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@PortableHoleId, @magicalWondrousTypeId, @rareRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RestorativeOintmentId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 5, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RobeOfEyesId, @magicalWondrousTypeId, @rareRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RobeOfScintillatingColorsId, @magicalWondrousTypeId, @veryRareRarityId, 1, '', 3, 1, 1, @d3Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RobeOfStarsId, @magicalWondrousTypeId, @veryRareRarityId, 1, '', 6, 1, 1, @d6Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RobeOfTheArchmagiId, @magicalWondrousTypeId, @legendaryRarityId, 1, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
(@RobeOfUsefulItemsId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@StoneOfControllingEarthElementalsId, @magicalWondrousTypeId, @rareRarityId, 0, '', 1, 1, 0, @d1Id, 1, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@TalismanOfPureGoodId, @magicalWondrousTypeId, @legendaryRarityId, 1, '', 7, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@TalismanOfUltimateEvilId, @magicalWondrousTypeId, @legendaryRarityId, 1, '', 6, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@WindFanId, @magicalWondrousTypeId, @uncommonRarityId, 0, '', 0, 0, 0, @d1Id, 0, 0, 0, 0, 0, 0, 0, 4, 0, NULL, 0, 0, 4, 0, 0, @attunementTypeAnyId),
...
(@PlateArmorOfEtherealnessId, @EtherealnessId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@OilOfEtherealnessId, @EtherealnessId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@OilOfSlipperinessId, @FreedomOfMovementId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@OilOfSlipperinessId, @GreaseId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfAnimalFriendshipId, @AnimalFriendshipId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfClairvoyanceId, @ClairvoyanceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfDiminutionId, @EnlargeReduceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfGaseousFormId, @GaseousFormId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfGrowthId, @EnlargeReduceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfHeroismId, @BlessId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfMindReadingId, @DetectThoughtsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@PotionOfSpeedId, @HasteId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAnimalInfluenceId, @AnimalFriendshipId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAnimalInfluenceId, @FearId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAnimalInfluenceId, @SpeakWithAnimalsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAirElementalCommandId, @DominateMonsterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAirElementalCommandId, @ChainLightningId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAirElementalCommandId, @GustOfWindId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfAirElementalCommandId, @WindWallId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfEarthElementalCommandId, @DominateMonsterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfEarthElementalCommandId, @StoneShapeId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfEarthElementalCommandId, @StoneskinId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfEarthElementalCommandId, @WallOfStoneId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfFireElementalCommandId, @DominateMonsterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfFireElementalCommandId, @BurningHandsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfFireElementalCommandId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfFireElementalCommandId, @WallOfFireId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfWaterElementalCommandId, @DominateMonsterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfWaterElementalCommandId, @CreateOrDestroyWaterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfWaterElementalCommandId, @ControlWaterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfWaterElementalCommandId, @IceStormId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfWaterElementalCommandId, @WallOfIceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfJumpingId, @JumpId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfShootingStarsId, @FaerieFireId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfTelekinesisId, @TelekinesisId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RingOfThreeWishesId, @WishId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RodOfAlertnessId, @DetectEvilAndGoodId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RodOfAlertnessId, @DetectMagicId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RodOfAlertnessId, @DetectPoisonAndDiseaseId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RodOfAlertnessId, @SeeInvisibilityId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfCharmingId, @CharmPersonId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfCharmingId, @CommandId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfCharmingId, @ComprehendLanguagesId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFireId, @BurningHandsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFireId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFireId, @WallOfFireId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFrostId, @ConeOfColdId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFrostId, @FogCloudId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFrostId, @IceStormId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfFrostId, @WallOfIceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfHealingId, @CureWoundsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfHealingId, @LesserRestorationId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfHealingId, @MassCureWoundsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @ConeOfColdId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @GlobeOfInvulnerabilityId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @HoldMonsterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @LevitateId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @LightningBoltId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @MagicMissileId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @RayOfEnfeeblementId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfPowerId, @WallOfForceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfSwarmingInsectsId, @GiantInsectId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfSwarmingInsectsId, @InsectPlagueId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @DispelMagicId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @FlamingSphereId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @IceStormId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @InvisibilityId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @KnockId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @LightningBoltId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @PasswallId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @PlaneShiftId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @TelekinesisId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @WallOfFireId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @WebId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @ArcaneLockId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @DetectMagicId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @EnlargeReduceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @LightId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @MageHandId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheMagiId, @ProtectionFromEvilAndGoodId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @AnimalFriendshipId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @AwakenId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @BarkskinId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @LocateAnimalsOrPlantsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @SpeakWithAnimalsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @SpeakWithPlantsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @WallOfThornsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StaffOfTheWoodlandsId, @PassWithoutTraceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfBindingId, @HoldMonsterId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfBindingId, @HoldPersonId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfFearId, @CommandId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfFireballsId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfLightningBoltsId, @LightningBoltId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfMagicDetectionId, @DetectMagicId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfMagicMissilesId, @MagicMissileId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfPolymorphId, @PolymorphId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWebId, @WebId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @SlowId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @FaerieFireId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @GustOfWindId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @DetectThoughtsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @StinkingCloudId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @LightningBoltId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @EnlargeReduceId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @DarknessId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WandOfWonderId, @InvisibilityId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@TridentOfFishCommandId, @DominateBeastId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@AmuletOfThePlanesId, @PlaneShiftId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@BootsOfLevitationId, @LevitateId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@BowlOfCommandWaterElementalsId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@BrazierOfCommandingFireElementalsId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CandleOfInvocationId, @GateId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CapeOfTheMountebankId, @DimensionDoorId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CenserOfControllingAirElementalsId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CircletOfBlastingId, @ScorchingRayId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CloakOfArachnidaId, @WebId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CrystalBallId, @ScryingId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CrystalBallOfMindReadingId, @ScryingId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CrystalBallOfMindReadingId, @DetectThoughtsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CrystalBallOfTelepathyId, @ScryingId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CrystalBallOfTelepathyId, @SuggestionId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CrystalBallOfTrueSeeingId, @ScryingId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CubicGateId, @GateId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@CubicGateId, @PlaneShiftId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@DeckOfManyThingsId, @WishId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@EfreetiBottleId, @WishId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@ElementalGemBlueSapphireId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@ElementalGemYellowDiamondId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@ElementalGemRedCorundumId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@ElementalGemEmeraldId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@EyesOfCharmingId, @CharmPersonId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@FigurineOfWondrousPowerSilverRavenId, @AnimalMessengerId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HatOfDisguiseId, @DisguiseSelfId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfBrillianceId, @DaylightId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfBrillianceId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfBrillianceId, @PrismaticSprayId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfBrillianceId, @WallOfFireId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfComprehendingLanguagesId, @ComprehendLanguagesId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfTelepathyId, @DetectThoughtsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfTelepathyId, @SuggestionId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@HelmOfTeleportationId, @TeleportId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@MedallionOfThoughtsId, @DetectThoughtsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfFireballsId, @FireballId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @BlessId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @CureWoundsId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @LesserRestorationId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @GreaterRestorationId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @BrandingSmiteId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @PlanarAllyId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@NecklaceOfPrayerBeadsId, @WindWalkId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@RobeOfStarsId, @MagicMissileId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@StoneOfControllingEarthElementalsId, @ConjureElementalId, 0, 0, 0, 0, 0, 0, 0, 0, 0),
(@WindFanId, @GustOfWindId, 0, 0, 0, 0, 0, 0, 0, 0, 0);
...
SET @SpellScrollTableId = (SELECT id FROM magical_item_tables WHERE magical_item_id = @SpellScrollId LIMIT 1);
...
(@SpellScrollTableId, 0, 0, 'Spell Level'),
(@SpellScrollTableId, 0, 1, 'Rarity'),
(@SpellScrollTableId, 0, 2, 'Save DC'),
(@SpellScrollTableId, 0, 3, 'Attack'),
(@SpellScrollTableId, 1, 0, 'Cantrip'),
(@SpellScrollTableId, 1, 1, 'Common'),
(@SpellScrollTableId, 1, 2, '13'),
(@SpellScrollTableId, 1, 3, '+5'),
(@SpellScrollTableId, 2, 0, '1st'),
(@SpellScrollTableId, 2, 1, 'Common'),
(@SpellScrollTableId, 2, 2, '13'),
(@SpellScrollTableId, 2, 3, '+5'),
(@SpellScrollTableId, 3, 0, '2nd'),
(@SpellScrollTableId, 3, 1, 'Uncommon'),
(@SpellScrollTableId, 3, 2, '13'),
(@SpellScrollTableId, 3, 3, '+5'),
(@SpellScrollTableId, 4, 0, '3rd'),
(@SpellScrollTableId, 4, 1, 'Uncommon'),
(@SpellScrollTableId, 4, 2, '15'),
(@SpellScrollTableId, 4, 3, '+7'),
(@SpellScrollTableId, 5, 0, '4th'),
(@SpellScrollTableId, 5, 1, 'Rare'),
(@SpellScrollTableId, 5, 2, '15'),
(@SpellScrollTableId, 5, 3, '+7'),
(@SpellScrollTableId, 6, 0, '5th'),
(@SpellScrollTableId, 6, 1, 'Rare'),
(@SpellScrollTableId, 6, 2, '17'),
(@SpellScrollTableId, 6, 3, '+9'),
(@SpellScrollTableId, 7, 0, '6th'),
(@SpellScrollTableId, 7, 1, 'Very Rare'),
(@SpellScrollTableId, 7, 2, '17'),
(@SpellScrollTableId, 7, 3, '+9'),
(@SpellScrollTableId, 8, 0, '7th'),
(@SpellScrollTableId, 8, 1, 'Very Rare'),
(@SpellScrollTableId, 8, 2, '17'),
(@SpellScrollTableId, 8, 3, '+10'),
(@SpellScrollTableId, 9, 0, '8th'),
(@SpellScrollTableId, 9, 1, 'Very Rare'),
(@SpellScrollTableId, 9, 2, '18'),
(@SpellScrollTableId, 9, 3, '+10'),
(@SpellScrollTableId, 10, 0, '9th'),
(@SpellScrollTableId, 10, 1, 'Legendary'),
(@SpellScrollTableId, 10, 2, '19'),
(@SpellScrollTableId, 10, 3, '+11'),
